...
import "theme.dart" show ThemeMode, CustomStyleRule;

export "_catppuccin/base.dart";

StyleRule catppuccinTheme(Flavor flavor, ThemeMode mode) {
  final String mainL = mode.name == "dark" ? "4%" : "100%";
  final String shadowL = mode.name == "dark" ? "100%" : "4%";

  return CustomStyleRule("""
.theme-${mode.name}, [data-theme=${mode.name}] {
  --bulma-scheme-brightness: ${mode.name};

  --bulma-scheme-h: ${flavor.base.h};
  --bulma-scheme-s: ${flavor.base.s}%;
  --bulma-background-l: ${flavor.base.l}%;
  ...
  --bulma-white-h: ${flavor.base.h};
  --bulma-white-s: ${flavor.base.s}%;
  --bulma-white-l: 100%;
  --bulma-white-invert-l: 4%;
  --bulma-white-invert: hsl(221, 14%, 4%);
  --bulma-white-on-scheme-l: 35%;

  --bulma-black-rgb: 8.772, 9.6764, 11.628;  /* // TODO: calculate black rgb */
  --bulma-black-h: ${flavor.base.h};
  --bulma-black-s: ${flavor.base.s}%;
  --bulma-black-l: 4%;
  ...
  --bulma-text-weak-l: ${flavor.text.l}%;
  --bulma-text-strong-l: ${flavor.text.l}%;
  --bulma-text-title-l: ${flavor.text.l}%;
  --bulma-text-rgb: ${flavor.text.r}, ${flavor.text.g}, ${flavor.text.b};
  --bulma-text-h: ${flavor.text.h};
  --bulma-text-s: ${flavor.text.s}%;
  --bulma-text-l: ${flavor.text.l}%;
  --bulma-text-00-l: 0%;
  --bulma-text-05-l: 4%;
  --bulma-text-10-l: 9%;
  --bulma-text-15-l: 14%;
  ...
  --bulma-body-color: hsla(var(--bulma-text-h), var(--bulma-text-s), var(--bulma-text-l), 1);
  --bulma-strong-color: hsla(var(--bulma-text-h), var(--bulma-text-s), var(--bulma-text-strong-l), 1);
